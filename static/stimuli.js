...
// Lightness values range from 1 to 6 in the CSV
...
// These were generated by starting at #d6604d (taken from ColorBrewer RdBu)
// and going up/down by increments of 6 L*.
// Code generating them can be found in https://observablehq.com/@ealexander/cielab-tester
var targetColors = [
    '#000000',
    '#a03024',
    '#b24031',
                        ...
                        distractors = data.map(function (dictionary) {
                            if (dictionary["html"] === "target") {
                                ...
                                if (task.hasOwnProperty('big_lightness')) {
                                    colorStr += '; color:' + distractorColors[Math.floor(Math.random()*distractorColors.length)];
                                }
                                return {
                                    text: dictionary['text'],
                                    weight: dictionary['fontsize'],
                                    html: { class: dictionary['html'],
                                            style: 'visibility: hidden' + colorStr },
                                    handlers: {
